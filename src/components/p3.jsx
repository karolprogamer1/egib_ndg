...
const P3 = ({ formType }) => {
  const [formData, setFormData] = useState({
    ...
    // Wybrany zbiór GESUT (klasa obiektów)
    siecWodociagowa: false,
    siecKanalizacyjna: false,
    siecElektroenergetyczna: false,
    siecGazowa: false,
    siecCieplownicza: false,
    siecTelekomunikacyjny: false,
    siecSpecjalna: false,
    siecNiezidentyfikowana: false,
    urzadzeniaTowarzyszace: false,
    inneUrzadzenia: false,
    ...
    <div className="form-container">
      <div className="form-column">
        <div className="form-wrap">
          <h2>Formularz P3 - Szczegóły wniosku o udostępnienie zbioru danych bazy danych geodezyjnej ewidencji sieci uzbrojenia terenu (GESUT)</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2rem'}}>
              ...
              <div style={{border: '1px solid #ccc', padding: '1rem', borderRadius: '4px'}}>
                <h4>Wybrany zbiór danych GESUT (klasa obiektów)</h4>
                <div className="field checkbox">
                  <label>
                    <input type="checkbox" checked={formData.siecWodociagowa} onChange={() => handleCheckboxChange('siecWodociagowa')} />
                    sieć wodociągowa
                  </label>
                  <label>
                    <input type="checkbox" checked={formData.siecKanalizacyjna} onChange={() => handleCheckboxChange('siecKanalizacyjna')} />
                    sieć kanalizacyjna
                  </label>
                  <label>
                    <input type="checkbox" checked={formData.siecElektroenergetyczna} onChange={() => handleCheckboxChange('siecElektroenergetyczna')} />
                    sieć elektroenergetyczna
                  </label>
                  <label>
                    <input type="checkbox" checked={formData.siecGazowa} onChange={() => handleCheckboxChange('siecGazowa')} />
                    sieć gazowa
                  </label>
                  <label>
                    <input type="checkbox" checked={formData.siecCieplownicza} onChange={() => handleCheckboxChange('siecCieplownicza')} />
                    sieć ciepłownicza
                  </label>
                  <label>
                    <input type="checkbox" checked={formData.siecTelekomunikacyjny} onChange={() => handleCheckboxChange('siecTelekomunikacyjny')} />
                    sieć telekomunikacyjny
                  </label>
                  <label>
                    <input type="checkbox" checked={formData.siecSpecjalna} onChange={() => handleCheckboxChange('siecSpecjalna')} />
                    sieć specjalna
                  </label>
                  <label>
                    <input type="checkbox" checked={formData.siecNiezidentyfikowana} onChange={() => handleCheckboxChange('siecNiezidentyfikowana')} />
                    sieć niezidentyfikowana
                  </label>
                  <label>
                    <input type="checkbox" checked={formData.urzadzeniaTowarzyszace} onChange={() => handleCheckboxChange('urzadzeniaTowarzyszace')} />
                    urządzenia towarzyszące liniowe
                  </label>
                  <label>
                    <input type="checkbox" checked={formData.inneUrzadzenia} onChange={() => handleCheckboxChange('inneUrzadzenia')} />
            ...
            <div className="actions">
              <button type="submit">Wyślij formularz P3</button>
            </div>
            ...
            {submitted && (
              <div className="submitted">
                <strong>Sukces!</strong> Formularz P3 został wysłany. Odpowiedź otrzymasz na podany adres email.
              </div>
            )}
          </form>
        </div>

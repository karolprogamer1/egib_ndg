...
const P7 = ({ formType }) => {
  const [formData, setFormData] = useState({
    ...
    phone: '',
    epuapSignature: '',
    // Section 1: Szczegóły wniosku o udostępnienie innych materiałów
    dokumentWchodzacy: false,
    inneNiewymienione: '',
    
    // Postać
    postacElektroniczna: false,
    postacDrukowana: false,
    liczbaEgzemplarzy: '',
    ...
    <div className="form-container">
      <div className="form-column">
        <div className="form-wrap">
          <h2>Formularz P7 - Szczegóły wniosku o udostępnienie innych materiałów</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2rem'}}>
              <div style={{border: '1px solid #ccc', padding: '1rem', borderRadius: '4px'}}>
                <h3>1. Szczegóły wniosku o udostępnienie innych materiałów</h3>
                <div className="field checkbox">
                  <label>
                    <input
                      type="checkbox"
                      checked={formData.dokumentWchodzacy}
                      onChange={() => handleCheckboxChange('dokumentWchodzacy')}
                    />
                    Dokument wchodzący w skład operatu technicznego
                  </label>
                  <label>
                    <input 
                      type="checkbox"
                      checked={formData.inneNiewymienione !== ''}
                      onChange={(e) => handleChange({target: {name: 'inneNiewymienione', value: e.target.checked ? 'inne' : ''}})}
                    />
                    Inne niewymienione: 
                    <input 
                      type="text" 
                      name="inneNiewymienione"
                      value={formData.inneNiewymienione}
                      onChange={handleChange}
                      style={{marginLeft: '0.5rem', width: '200px'}}
                      placeholder="Wpisz inne materiały..."
                    />
                  </label>
                </div>
              </div>
              ...
              <div style={{border: '1px solid #ccc', padding: '1rem', borderRadius: '4px'}}>
                ...
                <div className="field checkbox">
                  <label>
                    <input 
                      type="checkbox"
                      checked={formData.postacElektroniczna}
                      onChange={() => handleCheckboxChange('postacElektroniczna')}
                    />
                    elektroniczna
                  </label>
                  <label>
                    <input 
                      type="checkbox"
                      checked={formData.postacDrukowana}
                      onChange={() => handleCheckboxChange('postacDrukowana')}
                    />
                    drukowana
                  </label>
            ...
            <div className="actions">
              <button type="submit">Wyślij formularz P7</button>
            </div>
            ...
            {submitted && (
              <div className="submitted">
                <strong>Sukces!</strong> Formularz P7 został wysłany. Odpowiedź otrzymasz na podany adres email.
              </div>
            )}
          </form>
        </div>
